...
if __name__ == "__main__":
    ...
    signal_state = pd.read_excel(fold_ini_path + 'state_blue_line//state_signal_缠论00207232' + '.xlsx',
    ...
    signal_state.to_excel(
        fold_ini_path + 'state_blue_line//state_signal_缠论00207232' + 'dropduplicate.xlsx',
        encoding='gbk')